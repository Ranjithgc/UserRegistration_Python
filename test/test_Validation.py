...
from AllEmailSamples import EmailSamples 
import unittest
...
class TestUserValidation(unittest.TestCase):
    ...
    def test_givenValidEmail_shouldReturnTrue(self):
        ...
        self.assertTrue(validate.validateEmail(EmailSamples.validEmails))
    ...
    def test_givenInvalidEmail_shouldReturnFalse(self):
        ...
        self.assertFalse(validate.validateEmail(EmailSamples.inValidEmails))
